...
const GaugeCharts = ({ gaugeData, apexChartsLoaded, }) => {
    const allowanceChartRef = useRef(null);
    const emissionChartRef = useRef(null);
    const allowanceChartInstance = useRef(null);
    const emissionChartInstance = useRef(null);
    useEffect(() => {
        if (!apexChartsLoaded)
            return;
        // 기존 차트 정리
        ...
        if (allowanceChartRef.current) {
                        ...
                        dataLabels: {
                            ...
                            value: {
                                ...
                                formatter: function (val) {
                                    return Math.round(gaugeData.탄소배출권_보유수량).toLocaleString();
                                },
                            },
                        },
                    },
            ...
            allowanceChartInstance.current = new window.ApexCharts(allowanceChartRef.current, allowanceOptions);
        ...
        if (emissionChartRef.current) {
            ...
            emissionChartInstance.current = new window.ApexCharts(emissionChartRef.current, emissionOptions);
